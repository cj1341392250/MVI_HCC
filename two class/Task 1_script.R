...
legend("bottomright",
       c(paste0("Model AP1 AUC=",round(train_AP_roc$auc,3)), 
         paste0("Model PVP1 AUC=",round(train_PVP_roc$auc,3)), 
         paste0("Model T2-1 AUC=",round(train_T2_roc$auc,3)),
         paste0("Model B1 AUC=",round(train_B1_roc$auc,3)), 
         paste0("Model A1 AUC=",round(train_Clin_roc$auc,3)), 
         paste0("Model C1 AUC=",round(train_C1_roc$auc,3))
       ),
...
legend("bottomright",
       c(paste0("Model AP1 AUC=",round(test_AP_roc$auc,3)), 
         paste0("Model PVP1 AUC=",round(test_PVP_roc$auc,3)), 
         paste0("Model T2-1 AUC=",round(test_T2_roc$auc,3)),
         paste0("Model B1 AUC=",round(test_B1_roc$auc,3)), 
         paste0("Model A1 AUC=",round(test_Clin_roc$auc,3)), 
         paste0("Model C1 AUC=",round(test_C1_roc$auc,3))
       ),
       col=c("#1C9A35", "#1B4E8C", "#EDB85D", "#6595A3","#555555","#E41A1C"),
       lty=1, lwd=2,bty = "n"
)
...
dca_df$model[dca_df$model=='PVP_model']='Model PVP1' 
dca_df$model[dca_df$model=='T2_model']='Model T2-1' 
